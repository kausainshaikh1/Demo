		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 contact-info">
					...
					<br><br>
					<form action="actions/contact-us-code.php" method="post" class="contact-form">
						<input type="text" name="customer_name" placeholder="Your name"><br>
						<input type="text" name="Email_ID" placeholder="Your e-mail"><br>
						<input type="text" name="subject" placeholder="Subject"><br>
						<textarea name="message" placeholder="Message"></textarea>
						<input type="submit" name="submit" class="site-btn">SEND NOW</button>
					</form>
				</div>
			</div>
		</div>
