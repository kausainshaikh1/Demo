			...
			<div class="container">
				...
				<ul class="main-menu">
					...
					<li><a href="#">Collections</a>
						<ul class="sub-menu">
							<li><a href="./casualwear.html">Casual Wear</a></li>
							<li><a href="./partywear.html">Party Wear</a></li>
							<li><a href="./designerwear.html">Designer Wear</a></li>
						</ul>
					</li>
					<li><a href="#">Category</a>
						<ul class="sub-menu">
							...
							<li><a href="./categorylehangas.html">Lehangas</a></li>
						</ul>
					</li>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;
					<li><a href="./cart.html">Shopping Cart    (<?php
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row ">
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                             <a href="payment.html"><input type="submit" class="btn btn-danger btn-block" value="CANCEL" required="" /></a>   
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
