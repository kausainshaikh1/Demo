				...
				<form action="manage_cart.php" method="POST">
					...
					<div class="filter-widget">
						...
						<ul class="category-menu">
							...
							<li><a href="#">INAAYAT</a></li>
							<li><a href="#">AARAV</a></li>
						</ul>
					</div>
                    </form></div>
				...
				<div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
					<div class="row">
                         ...
                         <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									...
									<img src="./Dresses/lehangas/1.jpg" alt="">
									<div class="pi-links">
								...
								<div class="pi-text">
									<h6>price 5800</h6>
									<p>MAISHA Collection [D.No:20002]</p>
								</div>
                                <input type="hidden" name="Item_Name" value="MAISHA Collection [D.No:20002]">
                        ...
                        <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/6.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>price 3900</h6>
									<p>Designer Saree Collection [D.No: 1251]</p>
								</div>
                                 <input type="hidden" name="Item_Name" value="Designer Saree Collection [D.No: 1251]">
                    ...
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/5.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>price 3900</h6>
									<p>Designer Saree Collection [D.No: 1241]</p>
								</div>
                                <input type="hidden" name="Item_Name" value="Designer Saree Collection [D.No: 1241]">
                                 <input type="hidden" name="price" value="3900">
							</div>
                            </form></div>
						<div class="col-lg-4 col-sm-6">
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/2.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>price 6500</h6>
									<p>MAISHA Collection [D.No:20006]</p>
								</div>
                                <input type="hidden" name="Item_Name" value="MAISHA Collection [D.No:20006]">
                    ...
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/3.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>price 4300</h6>
									<p>MAISHA Collection [D.No:20004]</p>
								</div>
                                 <input type="hidden" name="Item_Name" value="MAISHA Collection [D.No:20004]">
                    ...
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/4.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>price 3500</h6>
									<p>INAAYAT Collection [D.No:22525]</p>
								</div>
                                 <input type="hidden" name="Item_Name" value="INAAYAT Collection [D.No:22525]">
                                 <input type="hidden" name="price" value="6500">
							</div>
                            </form></div>
						<div class="col-lg-4 col-sm-6">
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/10.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
                    ...
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/14.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>price 3500</h6>
									<p>FIONA Collection [D.No:22354]</p>
								</div>
                                 <input type="hidden" name="Item_Name" value="FIONA Collection [D.No:22354]">
                                 <input type="hidden" name="price" value="3500">
							</div>
                            </form></div>
						<div class="col-lg-4 col-sm-6">
                    ...
                    <form action="manage_cart.php" method="POST">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/12.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
                    ...
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									...
									<img src="./Dresses/lehangas/13.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
                    ...
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/15.jpg" alt="">
									<div class="pi-links">
										<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>price 3500</h6>
									<p>NITYA Collection [D.No:45008]</p>
								</div>
                                 <input type="hidden" name="Item_Name" value="NITYA Collection [D.No:45008]">
                                 <input type="hidden" name="price" value="3500">
							</div>
                            </form></div>
						<div class="col-lg-4 col-sm-6">
                    <form action="manage_cart.php" method="POST">
							<div class="product-item">
								<div class="pi-pic">
									<img src="./Dresses/lehangas/8.jpg" alt="">
									<div class="pi-links">
									<button type="submit" name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
										<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
									</div>
								...
								<div class="pi-text">
									<h6>price 3500</h6>
									<p>NITYA Collection [D.No:4901]</p>
								</div>
                                <input type="hidden" name="Item_Name" value="NITYA Collection [D.No:4901]">
                                 <input type="hidden" name="price" value="3500">
							</div>
                            </form></div>
